# More Consumables In Shops 

This mod adds more consumable Rosary/Shell Shard items to shop menus. Some items have additional requirements that must be fulfilled before they can be unlocked. 

| Item                  | Price | Unlock Requirements                                                  |
| ----                  | ----- | -------------------                                                  |
| Frayed Rosary String  |  50   | None                                                                 |
| Rosary String         |  80   | None                                                                 |
| Rosary Necklace       | 140   | *SAVE: The Threadspun Town* wish                                     |
| Heavy Rosary Necklace | 240   | Varies depending on the NPC (see table below)                        |
| Pale Rosary Necklace  | 360   | Varies depending on the NPC (see table below)                        |
| Shard Bundle          |  50   | None                                                                 |
| Beast Shard           |  90   | Started Act 2                                                        |
| Pristine Core         | 140   | Met the Twelfth Architect and acquired the Architect's Melody        |
| Hornet Statuette      | 200   | *An Icon of Hope* wish or visit destroyed Bone Bottom in Act 3       |
...
| Mottled Skarr     | Shards   | N/A                               | N/A                                 |
| Pebb              | Rosaries | *Bone Bottom Supplies* wish       | *The Terrible Tyrant* wish          |
| Twelfth Architect | Shards   | N/A                               | N/A                                 |
...
The sell price of each item, alongside whether it can be found in shops at all, can be changed in the config settings. 